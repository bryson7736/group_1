...
def test_wave_info():
    ...
    # Wave 0
    base, is_boss, is_true_boss = lm.wave_info(0)
    assert base == WAVE_BASE_COUNT
    assert is_boss is False
    assert is_true_boss is False
    
    # Wave 1
    base_1, is_boss_1, is_true_boss_1 = lm.wave_info(1)
    ...
    assert is_true_boss_1 is False
    
    # Wave 5 (Boss wave logic check: >0 and %5==0)
    _, is_boss_5, is_true_boss_5 = lm.wave_info(5)
    assert is_boss_5 is True
    assert is_true_boss_5 is False

    # Wave 10 (True Boss wave logic check: >0 and %10==0)
    _, is_boss_10, is_true_boss_10 = lm.wave_info(10)
    assert is_boss_10 is True
    assert is_true_boss_10 is True
